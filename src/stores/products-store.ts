          ...
          options: [
            {
              ...
              type: "color",
              colors: [
                { id: "pale-blue", label: "Pale Blue", hex: "#B8D4E8" },
                { id: "pale-sage", label: "Pale Sage", hex: "#B5C9B7" },
                { id: "lavender", label: "Lavender", hex: "#C8B8D9" },
                { id: "blush", label: "Blush", hex: "#F0C8C8" },
          ...
          options: [
            {
              ...
              type: "color",
              colors: [
                { id: "pale-sky", label: "Pale Sky", hex: "#B8CDD9" },
                { id: "pale-mint", label: "Pale Mint", hex: "#A8CFC8" },
                { id: "blush", label: "Blush", hex: "#F0C4B4" },
                { id: "white", label: "White", hex: "#ffffff" },
                { id: "black", label: "Black", hex: "#1a1a1a" },
                { id: "red", label: "Red", hex: "#e53e3e" },
                { id: "blue", label: "Blue", hex: "#3182ce" },
          ...
          options: [
            {
              ...
              colors: [
                ...
                { id: "pale-sand", label: "Pale Sand", hex: "#E8D5B7" },
